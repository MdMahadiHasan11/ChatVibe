          ...
          <div className="flex-1 h-full flex flex-col justify-center text-left md:p-4 lg:p-4 lg:mr-4 space-y-4 lg:space-y-6">
            ...
            <div className="flex flex-col gap-4 md:flex-row space-x-3">
              <Link
                ...
                className="bg-blue-500 text-center text-white p-2 md:py-2 md:px-4 rounded-lg hover:bg-blue-600 transition duration-300 w-full">
                Try Now
              </Link>
            </div>

            {/* This was previous hero section crated by Ashraful Islam Tuser */}
